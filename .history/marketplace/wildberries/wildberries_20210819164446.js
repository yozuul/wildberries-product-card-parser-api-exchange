...
class WildberriesAPI {
  ...
  async getDirectoryList(pattern) {
    ...
    if(!cyrillicPattern.test(pattern.split(' ')[0])) lang = 'en'
    const encode = encodeURI(pattern)
    const url = `${this.apiPath}/api/v1/config/get/object/list?pattern=${encode}&lang=${lang}`
    // const url1 = `https://suppliers-api.wildberries.ru/api/v1/config/get/object/list?pattern=%D0%A5%D1%83%D0%B4%D0%B8&lang=ru`
    // const url2 = `https://suppliers-api.wildberries.ru/api/v1/config/get/object/list?pattern=%D0%A5%D1%83%D0%B4%D0%B8&lang=ru`
