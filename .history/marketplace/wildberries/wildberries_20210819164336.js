...
class WildberriesAPI {
  ...
  async getDirectoryList(pattern) {
    ...
    // const url = `${this.apiPath}/api/v1/config/get/object/parent/list?pattern=${encode}&lang=${lang}`
    const url = `https://suppliers-api.wildberries.ru/api/v1/config/get/object/list?pattern=%D0%A5%D1%83%D0%B4%D0%B8&lang=ru`
