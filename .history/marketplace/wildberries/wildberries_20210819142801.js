...
class WildberriesAPI {
   ...
   test(data) {
     this.wd = 'https://suppliers-api.wildberries.ru'
      // this.getBarCode()
      // this.getPattern('игр')
   ...
   async getDirectoryList() {
    const encode = encodeURI('игр')
    const url = `https://suppliers-api.wildberries.ru/api/v1/config/get/object/list?pattern=${encode}`
    try {
       const response = await axios.get(url, {"jsonrpc": '2.0'}, {
          headers: {
