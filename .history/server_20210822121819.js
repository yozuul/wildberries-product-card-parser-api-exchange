...
import dotEnvJSON from 'dotenv-to-json'

console.log(dotEnvJSON('foo = bar'));
const app = new Koa()
...
//  }
  ...
  const buff = Buffer.from(dataStr);
  ...
  try {
    ...
    const promise = writeFile('./.exports/message.json', JSON.stringify(data));
