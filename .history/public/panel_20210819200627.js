...
class Panel {
   ...
   passDataToFields(data) {
      ...
      const commonDataFields = [
         input.cardProductName, input.cardProductBrand, input.cardProductPrice
      ]
      for(let input of commonDataFields) {
...
new Panel(api, button, element, inputs, select).waitParse()
