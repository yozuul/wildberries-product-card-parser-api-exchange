...
class Panel {
   ...
   getUpdatedFields() {
      const category =  select.productCategory.options[category.selectedIndex].text
      // const activeOption = category.options[category.selectedIndex].text
      console.log(category);
      const fields = [
         input.cardProductName.value, activeOption,
      ]
      // console.log(fields);
   }
