...
import { query, queryAll, show } from './utils/index'
import { FillFields } from './data-process/index'
import { DynamicSearch } from './utils/dynamic-search'
...
class Panel {
   ...
   async testSearch() {
      ...
      const result = await search.watchField(input.searchProductCategory)
   }
