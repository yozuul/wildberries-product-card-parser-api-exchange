...
class FieldsCleaner {
   restoreMarkup() {
      ...
      const hideElement = [
         button.saveCard, element.productImages_wrapper, element.productParams_wrapper, element.productExtras_wrapper, element.productExtrasNotFound_wrapper
      ]
      // Прячем
      ...
      const cleanChilds = [
         element.productImages, element.productParams_table, element.productExtras_wrapper, select.searchProductTnved_wrapper,
      ]
      // Удаляем
